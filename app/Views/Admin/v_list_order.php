                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link <?= $cari == null && $tanggal_awal == null && $tanggal_akhir == null ? 'active' : ''; ?>" href="<?= base_url('Admin/list_order/' . $id); ?>">Semua</a></li>
                        ...
                        <div style="margin-top: 10px;" class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?= base_url('Admin/list_order/' . $id); ?>" method="get">
                            ...
                            <tbody>
                                <tr>
                                    <?php foreach ($list_order as $key => $value) { ?>
                                        ...
                                        <td><?= $value['nama']; ?></td>
                                        <td><?= $value['jumlah']; ?></td>
                                        <td>Rp. <?= $value['id_mitra'] == 0 ? format_rupiah($value['harga_product']) : format_rupiah($value['harga_product'] * ($value['bagi_hasil'] / 100)); ?></td>
                                        <td>Rp. <?= $value['id_mitra'] == 0 ? format_rupiah($value['jumlah'] * $value['harga_product']) : format_rupiah($value['jumlah'] * ($value['harga_product'] * ($value['bagi_hasil'] / 100))); ?></td>
