                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url('Admin/kasir'); ?>">List Kasir</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link <?= $cari == null && $tanggal_awal == null && $tanggal_akhir == null ? 'active' : ''; ?>" href="<?= base_url('Admin/detail_kasir/' . $id); ?>">Semua</a></li>
                        ...
                        <div style="margin-top: 10px;" class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?= base_url('Admin/detail_kasir/' . $id); ?>" method="get">
                            ...
                            <tbody>
                                <tr>
                                    <?php foreach ($list_order as $key => $value) { ?>
                                        ...
                                        <td>Rp. <?= format_rupiah($value['jumlah'] * ($value['harga_product'])); ?></td>
                                        <td><?= $value['nama']; ?></td>
                                        <td><?= $value['kategori']; ?></td>
                                        <td><span class="badge badge-<?= $value['pembayaran'] != 2 ? 'danger' : 'success'; ?>"><?= $value['pembayaran'] != 2 ? 'Belum' : 'Lunas'; ?></span></td>
                                        <td><?= format_indo($value['created_at']); ?></td>
                                        <td><a class="btn btn-danger btn-xs konfirm" href="<?= base_url('Admin/hapus_order/' . $value['id_order'] . '/' . $value['id_kasir']); ?>"><i class="fas fa-trash"></i></a></td>
                                </tr>
                            <?php }; ?>
                            </tbody>
                            <tfoot>
