                                        ...
                                        <tr>
                                            ...
                                            foreach ($get_product as $key => $value) { ?>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a onclick="return confirm('Yakin....?')" href="<?= base_url(); ?>/User/hapus_product/<?= $value['id_kategori']; ?>/<?= $value['id_product']; ?>" class="btn btn-danger btn-sm"> Hapus</a>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <?php foreach ($get_kategori as $key => $value) {; ?>
                        <?= form_open_multipart('User/proses/' . $value['id_kategori']) ?>
                    <?php }; ?>
